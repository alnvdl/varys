...
func TestFeedSortedItems(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			initialItems: []feed.Item{
				{RawItem: feed.RawItem{URL: "url5"}, Timestamp: now},
				{RawItem: feed.RawItem{URL: "url3"}, Timestamp: now},
				{RawItem: feed.RawItem{URL: "url1"}, Timestamp: now},
				{RawItem: feed.RawItem{URL: "url4"}, Timestamp: now},
				{RawItem: feed.RawItem{URL: "url2"}, Timestamp: now},
			},
			expectedItems: []feed.Item{
				{RawItem: feed.RawItem{URL: "url1"}, Timestamp: now},
				{RawItem: feed.RawItem{URL: "url2"}, Timestamp: now},
...
func TestFeedRefresh(t *testing.T) {
	...
	tests := []struct {
		...
		items: []feed.RawItem{
			{URL: "url1", Title: "Updated Title 1"},
			{URL: "url2", Title: "Title 2"},
			{URL: "", Title: "Invalid Item"},
		},
		fetchErr: nil,
		expectedFeed: feed.Feed{
			Name: "Feed 1",
			URL:  "url1",
			Items: map[string]*feed.Item{
				feed.UID("url1"): {RawItem: feed.RawItem{URL: "url1", Title: "Updated Title 1"}, FeedUID: feed.UID("url1"), Timestamp: now},
				feed.UID("url2"): {RawItem: feed.RawItem{URL: "url2", Title: "Title 2"}, FeedUID: feed.UID("url1"), Timestamp: now},
			},
			LastRefreshedAt: now,
		},
	}}
